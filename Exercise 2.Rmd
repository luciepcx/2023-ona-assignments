...
```{r drawing the network graph, echo=FALSE}
...
```{r Degree centrality and plot,echo=FALSE}
...
```{r Closeness centrality and plot,echo=FALSE}
...
```{r Betweenness centrality and plot,echo=FALSE}
...
```{r Final graph with all centrality,echo=FALSE}
